...
# Sicherheitscheck: nur im Versionsordner 0.1.2 laufen
if BASE.name != "0.1.2":
    raise SystemExit(
        f"SICHERHEIT: setup_mms_project.py darf nur im Ordner '0.1.2' laufen. Aktuell: {BASE}"
    )
...
FILES = {
    "docs/README.md": "# MMS – Metamodell des Menschlichen Systems\n\n"
                      "Dies ist die Version 0.1.2 des MMS-Projekts.\n"
...
def main():
    ...
    print("\n🎉 MMS Projektstruktur (0.1.2) ist konsistent und sicher eingerichtet.")
